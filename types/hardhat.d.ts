...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "FHENPrivacyAuction",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FHENPrivacyAuction__factory>;
    getContractFactory(
      name: "PrivacyAuction",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.PrivacyAuction__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.FHENPrivacyAuction>;
    getContractAt(
      name: "PrivacyAuction",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.PrivacyAuction>;
